...
export class RectShape implements IShape {
    ...
    private dragStartOffset: { offsetX: number; offsetY: number } | any;

    public readonly shapeStyle: IShapeStyle;

    constructor(data: IAnnotation<IShapeData>, onChange: () => void, shapeStyle: IShapeStyle = defaultShapeStyle) {
