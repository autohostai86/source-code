...
import { addContainerClassname, changeDefaultClassnames, changeSelectedMenuHasSubItems, setContainerClassnames } from '../../redux/actions';
        ...
        return (
            <div className="sidebar">
                ...
                <div className="sub-menu">
                    <div className="scroll">
                        <PerfectScrollbar options={{ suppressScrollX: true, wheelPropagation: false }}>
                            <SubMenuItems selectedParentMenu={selectedParentMenu} viewingParentMenu={viewingParentMenu} />
                        </PerfectScrollbar>
                    </div>
                </div>
            </div>
